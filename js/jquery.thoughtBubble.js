...
$.fn.thoughtBubble = function( defaults ) {
    ...
    getBubbleDiv = function( container ) {
        ...
        var offset = container.offset(),
            ...
            style = '"position: absolute; top:' + modifiedHeight + 'px;width:' + settings.width + '; height:' + settings.height + ';"',
    ...
    getText = function() {
        ...
        return '<span style="z-index:10;vertical-align: middle; color: ' + settings.fontColor + ';font-size: ' + settings.fontSize + '; font-family: ' + settings.font + '">' + settings.text + '</span>';
